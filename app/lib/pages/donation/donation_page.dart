...
import 'package:chatx/model/state/purchase_state.dart';
import 'package:chatx/pages/donation/donation_page_vm.dart';
// [FOSS_REMOVE_START]
...
class DonationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder(
      ...
      builder: (context, vm) {
        return Scaffold(
          appBar: basicChatXAppbar(t.donationPage.title),
          body: Stack(
            children: [
              ResponsiveListView(
