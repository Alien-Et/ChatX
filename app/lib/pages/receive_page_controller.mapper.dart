...
class ReceivePageVmMapper extends ClassMapperBase<ReceivePageVm> {
  ...
  static const Field<ReceivePageVm, SessionStatus> _f$status = Field(
    'status',
    _$status,
  );
  static Device _$sender(ReceivePageVm v) => v.sender;
  static const Field<ReceivePageVm, Device> _f$sender = Field(
    'sender',
    _$sender,
  );
  static bool _$showSenderInfo(ReceivePageVm v) => v.showSenderInfo;
  static const Field<ReceivePageVm, bool> _f$showSenderInfo = Field(
    'showSenderInfo',
    _$showSenderInfo,
  );
  static int _$fileCount(ReceivePageVm v) => v.fileCount;
  static const Field<ReceivePageVm, int> _f$fileCount = Field(
    'fileCount',
    _$fileCount,
  );
  static String? _$message(ReceivePageVm v) => v.message;
  static const Field<ReceivePageVm, String> _f$message = Field(
    'message',
    _$message,
  );
  ...
  static const Field<ReceivePageVm, bool> _f$showFullIp = Field(
    'showFullIp',
    _$showFullIp,
  );
  ...
  static const Field<ReceivePageVm, Function> _f$onAccept = Field(
    'onAccept',
    _$onAccept,
    arg: _arg$onAccept,
  );
  ...
  static const Field<ReceivePageVm, Function> _f$onDecline = Field(
    'onDecline',
    _$onDecline,
    arg: _arg$onDecline,
  );
  ...
  static const Field<ReceivePageVm, Function> _f$onClose = Field(
    'onClose',
    _$onClose,
    arg: _arg$onClose,
  );
...
mixin ReceivePageVmMappable {
  String serialize() {
    return ReceivePageVmMapper.ensureInitialized().encodeJson<ReceivePageVm>(
      this as ReceivePageVm,
    );
  }

  Map<String, dynamic> toJson() {
    return ReceivePageVmMapper.ensureInitialized().encodeMap<ReceivePageVm>(
      this as ReceivePageVm,
    );
  }

  ReceivePageVmCopyWith<ReceivePageVm, ReceivePageVm, ReceivePageVm>
  get copyWith => _ReceivePageVmCopyWithImpl<ReceivePageVm, ReceivePageVm>(
    this as ReceivePageVm,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return ReceivePageVmMapper.ensureInitialized().stringifyValue(
      this as ReceivePageVm,
    );
  }
  ...
  bool operator ==(Object other) {
    return ReceivePageVmMapper.ensureInitialized().equalsValue(
      this as ReceivePageVm,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ReceivePageVmMapper.ensureInitialized().hashValue(
      this as ReceivePageVm,
    );
  }
}
...
extension ReceivePageVmValueCopy<$R, $Out>
  ...
  ReceivePageVmCopyWith<$R, ReceivePageVm, $Out> get $asReceivePageVm =>
      $base.as((v, t, t2) => _ReceivePageVmCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _ReceivePageVmCopyWithImpl<$R, $Out>
  ...
  ReceivePageVmCopyWith<$R2, ReceivePageVm, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _ReceivePageVmCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
