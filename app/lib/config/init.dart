...
import 'package:chatx/config/refena.dart';
...
import 'package:chatx/provider/app_arguments_provider.dart';
...
import 'package:chatx/provider/persistence_provider.dart';

// [FOSS_REMOVE_START]
import 'package:chatx/provider/purchase_provider.dart';
...
import 'package:chatx/provider/tv_provider.dart';
import 'package:chatx/provider/window_dimensions_provider.dart';
import 'package:chatx/util/i18n.dart';
import 'package:chatx/util/native/autostart_helper.dart';
import 'package:chatx/util/native/cache_helper.dart';
import 'package:chatx/util/native/content_uri_helper.dart';
import 'package:chatx/util/native/context_menu_helper.dart';
import 'package:chatx/util/native/cross_file_converters.dart';
import 'package:chatx/util/native/device_info_helper.dart';
import 'package:chatx/util/native/macos_channel.dart';
import 'package:chatx/util/native/platform_check.dart';
import 'package:chatx/util/native/tray_helper.dart';
import 'package:chatx/util/rhttp.dart';
import 'package:chatx/util/ui/dynamic_colors.dart';
import 'package:chatx/util/ui/snackbar.dart';
