...
class CrossFileMapper extends ClassMapperBase<CrossFile> {
  ...
  static const Field<CrossFile, AssetEntity> _f$asset = Field(
    'asset',
    _$asset,
    opt: true,
  );
  static String? _$path(CrossFile v) => v.path;
  static const Field<CrossFile, String> _f$path = Field(
    'path',
    _$path,
    opt: true,
  );
  static List<int>? _$bytes(CrossFile v) => v.bytes;
  static const Field<CrossFile, List<int>> _f$bytes = Field(
    'bytes',
    _$bytes,
    opt: true,
  );
